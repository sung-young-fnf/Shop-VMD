...
제공된 상품 사진에서 대표 SKU 14종(모자 6종, 신발 4종, 의류 4종)을 선정해 기존 진열에 적용했습니다. 사람이 포함된 착용 사진은 상품 재질과 모델 제작에서 제외했습니다. 사진에 보이지 않는 뒷면·밑면·내부와 접힌 형태는 근사이며, 상품 선택과 진열 수량은 실제 재고를 뜻하지 않습니다.
