...
## Development product study · 2026-09-07

This independent `mlb_shop_dev` copy studies the supplied caps, clothes and shoes product references. Operating `../mlb_shop` remains the baseline. Existing spatial, camera, keyboard, touch and walking contracts below remain applicable. Product geometry uses category-specific silhouettes with cropped product-only texture assets; source photograph backgrounds never become store geometry. The models are reference-backed visual studies, not certified SKU scans. Hidden backs, soles and folds remain inferred and must be identified in category evidence.

Reusable category factories preserve placement origins: cap at ground y=0, front +Z, about .23m wide; shoe at ground y=0, toe -X, .314m long; garment hook at origin with hem down to -.75m and front +Z; folded garment .34m by .30m footprint and .045m height. Central hangers rotate garments around Y by PI/2. Textured materials retain their maps through wall batching; late texture completion invalidates the idle renderer. Existing bags remain illustrative because no bag reference was supplied.

Development ports are 5175 (live editing) and 4175 (built preview), bound to 0.0.0.0 for the authorized company network. Original ports and runtime remain untouched. Product reviewers need both close-up fidelity and whole-store readability; browser evidence must cover original selection, walking and environment controls as well as product loading.
