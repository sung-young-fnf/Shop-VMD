...
| 항목 | 값 |
|---|---|
| 형태 ID | `MLBL-2421_MLBM-2421` |
| 라스트 (LAST NO.) | `MLBL-2421` |
| 아웃솔 (OUTSOLE NO.) | `MLBM-2421` |
| style_code | `M25SSDC01` (1개) |
...
| 스타일 수 / 컬러웨이 수 | 1 / 4 |
| 성수점 재고 합 (2026-09-06) | 10 |

## 이 형태를 쓰는 스타일 · 컬러웨이
| PART_CD | 상품명 (KG) | 도면 NAME/시즌/차수 | 시즌 | 컬러 수 | 컬러 코드 (KG) | 도면 헤더 컬러 | 라스트 표기 원문 | 아웃솔 표기 원문 |
|---|---|---|---|---:|---|---|---|---|
| `3ASDC0153` | 빅볼청키 필드 마스크 | 25SS / 1st | 25S | 4 | 50BKS, 50CRS, 50SIS, 50WHS |  | MLBL-2421 | MLBM-2421 |
...
<details><summary><code>3ASDC0153</code> 빅볼청키 필드 마스크 — 25SS 1st · KINGLIKE · JONGHOON KIM · 2024.07.01</summary>

- MICROFIBER SYNTHETIC AR-161M/W2, AR-169/W2, UMT/SILVER
- 15mm WEBBING/W2 PRINT SILVER
- ELASTIC BAND(24SS 동일)/W2
- STRING KI-SUNG FNKS080/W2 DOT SILVER
- STOPPER LOGO 3D PRINTING GLOSSY/SILVER
- CORD END LOGO PRINT SILVER
- LINING(24SS 동일)/W2
...
참고 컷/스와치: 24SS 빅볼청키 필더샌들 실물컷;코드엔드/스토퍼/스트링 실물컷
...
- `3ASDC0153`: 청키 필드 샌들. *Refer to 24SS Bigball Chunky Fielder Sandal sample for the pattern sample* — 패턴 원형은 24SS 필더샌들

## 컬러웨이 적용 규칙
| PART_CD | 도면 컬러칩 (팬톤/코드) | KG 컬러 코드 (전개) |
|---|---|---|
| `3ASDC0153` | PANTONE SILVER C SILVER(SIS); W2 WHITE(WHS) | 50BKS, 50CRS, 50SIS, 50WHS |
...
- 도면에 외부/실물 참고 컷이 붙어 있는 스타일: `3ASDC0153` — 디자인 의도 파악용이며 치수 근거는 아니다.
- 도면에는 자재 품번·협력사·담당자 실명·원가 관련 정보가 있다. **외부 공유·커밋 전 취급 확인 필수.**

## 출처
- `3ASDC0153` 도면: https://s3.ap-northeast-2.amazonaws.com/static-plm.fnf.co.kr/style/3ASDC0153.jpg · 제품컷: https://static-resource-mall.fnf.co.kr/mlb-korea/images/goods/ec/M25S3ASDC015350BKS/thnail/696E1EF5F985491EB9D9F635BFA80C53.png/dims/resize/200x200
